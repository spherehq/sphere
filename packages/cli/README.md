...
@spherehq/cli/0.8.0 linux-x64 node-v10.15.3
$ sphere --help [COMMAND]
USAGE
  $ sphere COMMAND
...
...
_See code: [src/commands/init.ts](https://github.com/spherehq/sphere/blob/v0.8.0/src/commands/init.ts)_
...
_See code: [src/commands/sync.ts](https://github.com/spherehq/sphere/blob/v0.8.0/src/commands/sync.ts)_
<!-- commandsstop -->
