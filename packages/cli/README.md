...
@spherehq/cli/0.6.9 linux-x64 node-v10.15.3
$ sphere --help [COMMAND]
USAGE
  $ sphere COMMAND
...
...
_See code: [src/commands/init.ts](https://github.com/spherehq/sphere/blob/v0.6.9/src/commands/init.ts)_
...
_See code: [src/commands/sync.ts](https://github.com/spherehq/sphere/blob/v0.6.9/src/commands/sync.ts)_
<!-- commandsstop -->
